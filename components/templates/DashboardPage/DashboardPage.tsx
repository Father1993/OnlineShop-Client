      ...
      <div className={`container ${styles.dashboard__container}`}>
        ...
        <div className={styles.dashboard__about}>
          ...
          <p className={`${styles.dashboard__about__text} ${darkModeClass}`}>
            Наша компания специализируется на установке и продаже аудио техники
            для автомобилей, а также предлагает сопутствующие товары. С 2005
            года мы обеспечиваем наших клиентов высококачественной аудио
            техникой, помогая превратить их поездки на автомобиле в истинное
            удовольствие.
          </p>
        </div>
      </div>
