...
import PartsImagesList from '@/components/modules/PartPage/PartsImagesList'
...
const PartPage = () => {
  ...
  const spinnerSlider = useStore(removeFromCartFx.pending)
        ...
        <div className={`${styles.part__top} ${darkModeClass}`}>
          ...
          <div className={styles.part__inner}>
            ...
            <div className={styles.part__info}>
              ...
              <span className={`${styles.part__info__stock} ${darkModeClass}`}>
